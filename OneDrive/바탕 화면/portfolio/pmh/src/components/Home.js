...
export default function Home() {
  ...
  const first = <div className="relative">
    <img className="w-full h-full object-cover"
      src="https://bangmim.github.io/ParkMiHyun/img/joy.JPG" alt="joy" />
  ...
  const second = <div className="relative">
    <img className="w-full h-full object-cover"
      src="https://bangmim.github.io/ParkMiHyun/img/communication.JPG" alt="communication" />
  ...
  const third = <div className="relative">
    <img className="w-full h-full object-cover"
      src="https://bangmim.github.io/ParkMiHyun/img/exercise1.jpg" alt="exercise" />
