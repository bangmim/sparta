    ...
    */
    <ScrollView style={styles.container}>
      ...
      <Image style={styles.mainImage} source={{uri:main}}/>
        ...
        {/* horizontal을 이용해 가로 스크롤 구현 (기본값 : false : 세로) */}
      ...
      <View style={styles.cardContainer}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardText}>
            ...
            {/* numberOfLines ={3} : 3줄만 나오게 구현 */}
            <Text style={styles.cardDesc} numberOfLines={5}>먹다 남은 피자는 수분이 날라가기 때문에 처음처럼 맛있게 먹을 수 없는데요. 이럴 경우 그릇에 물을 받아 전자레인지 안에서 1분 30초에서 2분 정도 함께 돌려주면 촉촉하게 먹을 수 있습니다. 물이 전자레인지 안에서 수증기를 일으키고, 피자에 촉촉함을 더해줍니다.</Text>
...
const styles = StyleSheet.create({
  ...
  mainImage: {  //이미지는 width와 height값을 넣어야 잘 적용이 된다.
    //컨텐츠의 넓이 값
    width:'90%',
    //컨텐츠의 높이 값
    height:200,
